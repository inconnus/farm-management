...
import { CameraPopup, MapMarkerMount } from '@features/map/components';
...
import { CctvIcon, MapPinIcon, SearchIcon } from 'lucide-react';
                    ...
                    return (
                      <div className="pb-1">
                        <div
                          ...
                          onClick={() =>
                            navigate(`/${orgSlug}/camera/${device.id}`)
                          }
                        >
  ...
  useEffect(() => {
    ...
    const addLayer = () => {
      ...
      const labelLayerId = layers?.find(
        (l: any) =>
          l.type === 'symbol' &&
          (l.id.includes('label') || l.id.includes('place')),
      )?.id;
