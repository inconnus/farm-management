...
var FS = {
  ...
  createDefaultDevices: () => {
    ...
    if (
      ...
      try {
        ...
        random_device = () => crypto_module['randomBytes'](1)[0];
      } catch (e) {
  ...
  absolutePath: (relative, base) => PATH_FS.resolve(base, relative),
...
function ensureOverloadTable(proto, methodName, humanName) {
  if (undefined === proto[methodName].overloadTable) {
    ...
    proto[methodName] = function () {
      ...
      if (!Object.hasOwn(proto[methodName].overloadTable, arguments.length)) {
        throwBindingError(
          "Function '" +
            humanName +
...
/** @type {function(...*):?} */
var _SysTransRegisterDataCallBack = (Module['_SysTransRegisterDataCallBack'] =
  function () {
    assert(
      runtimeInitialized,
      'you need to wait for the runtime to be ready (e.g. wait for main() to be called)',
...
var _emscripten_main_thread_process_queued_calls = (Module[
  ...
  return Module['asm']['emscripten_main_thread_process_queued_calls'].apply(
    null,
    arguments,
  );
});
