...
(() => {
  ...
  cwrap = function cwrap(ident, returnType, argTypes) {
    ...
    var argNames = argTypes.map((x, i) => '$' + i);
    ...
    var cfuncname = parseJSFunc(() => cfunc).returnValue;
    funcstr += 'var ret = ' + cfuncname + '(' + argNames.join(',') + ');';
    if (!numericRet) {
      var strgfy = parseJSFunc(() => Pointer_stringify).returnValue;
...
function integrateWasmJS() {
  ...
  var asm2wasmImports = {
    'f64-rem': (x, y) => x % y,
    'f64-to-int': (x) => x | 0,
    'i32s-div': (x, y) => ((x | 0) / (y | 0)) | 0,
    'i32u-div': (x, y) => ((x >>> 0) / (y >>> 0)) >>> 0,
    'i32s-rem': (x, y) => ((x | 0) % (y | 0)) | 0,
    'i32u-rem': (x, y) => ((x >>> 0) % (y >>> 0)) >>> 0,
    debugger: () => {
      debugger;
    },
  };
...
staticSealed = true;
Module['wasmTableSize'] = 564;
Module['wasmMaxTableSize'] = 564;
...
var _SetPrintLogFlag = (Module['_SetPrintLogFlag'] = function () {
  return Module['asm']['_SetPrintLogFlag'].apply(null, arguments);
});
...
var _DestroyAudEncode = (Module['_DestroyAudEncode'] = function () {
  return Module['asm']['_DestroyAudEncode'].apply(null, arguments);
});
var _pthread_mutex_unlock = (Module['_pthread_mutex_unlock'] = function () {
  return Module['asm']['_pthread_mutex_unlock'].apply(null, arguments);
});
var _GetRawDataBuffer = (Module['_GetRawDataBuffer'] = function () {
  return Module['asm']['_GetRawDataBuffer'].apply(null, arguments);
});
var __GLOBAL__sub_I_Decoder_cpp = (Module['__GLOBAL__sub_I_Decoder_cpp'] =
  function () {
...
var _SetPlayPosition = (Module['_SetPlayPosition'] = function () {
  return Module['asm']['_SetPlayPosition'].apply(null, arguments);
});
...
var _InputAudEncodeData = (Module['_InputAudEncodeData'] = function () {
  return Module['asm']['_InputAudEncodeData'].apply(null, arguments);
});
...
var _CreateAudEncode = (Module['_CreateAudEncode'] = function () {
  return Module['asm']['_CreateAudEncode'].apply(null, arguments);
});
...
var _GetAudFrameBuffer = (Module['_GetAudFrameBuffer'] = function () {
  return Module['asm']['_GetAudFrameBuffer'].apply(null, arguments);
});
...
var _SetAudEncodeParam = (Module['_SetAudEncodeParam'] = function () {
  return Module['asm']['_SetAudEncodeParam'].apply(null, arguments);
});
var _memmove = (Module['_memmove'] = function () {
  return Module['asm']['_memmove'].apply(null, arguments);
});
var _GetAudFrameData = (Module['_GetAudFrameData'] = function () {
  return Module['asm']['_GetAudFrameData'].apply(null, arguments);
});
